...
public class Prjava02 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("CreacioÌ� d'una branca del projecte prjava02");
            System.out.println("Afegint meÌ�s codi a la branca00 del projecte prjava02");
